...
class Action:
    ...
    def __init__(self, id:str, atype:ActionType, definition:object, description:str, upstream_dependences:Optional[List["Action"]]=[], downstream_dependences:Optional[List["Action"]]=[]):
        ...
        Args:
            ...
            upstream_dependences (list[Action], optional): action must done before the action. Defaults to [].
            downstream_dependences (list[Action], optional): action done after the action. Defaults to [].
        """
